...
func (x *VerificationOutput) Reset() {
	*x = VerificationOutput{}
...
func (x *VerificationOutput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VerificationOutput) ProtoMessage() {}

func (x *VerificationOutput) ProtoReflect() protoreflect.Message {
	mi := &file_protos_pubsub_proto_msgTypes[0]
...
// Deprecated: Use VerificationOutput.ProtoReflect.Descriptor instead.
func (*VerificationOutput) Descriptor() ([]byte, []int) {
	return file_protos_pubsub_proto_rawDescGZIP(), []int{0}
}

func (x *VerificationOutput) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *VerificationOutput) GetValid() bool {
	if x != nil {
		return x.Valid
	}
	return false
...
func (x *VerificationOutput) GetErrorMessage() string {
...
var file_protos_pubsub_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7c, 0x0a, 0x12, 0x56, 0x65, 0x72, 0x69, 0x66, 0x69, 0x63,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x65,
	0x6d, 0x61, 0x69, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69,
	0x6c, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x12, 0x28, 0x0a, 0x0d, 0x65, 0x72, 0x72, 0x6f, 0x72,
	...
	0x61, 0x67, 0x65, 0x42, 0x16, 0x5a, 0x14, 0x2e, 0x68, 0x61, 0x63, 0x6b, 0x61, 0x74, 0x68, 0x6f,
...
var file_protos_pubsub_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_protos_pubsub_proto_goTypes = []interface{}{
	(*VerificationOutput)(nil), // 0: VerificationOutput
}
...
func file_protos_pubsub_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_protos_pubsub_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VerificationOutput); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_protos_pubsub_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
